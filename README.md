...
![Figure 2: Forward and Inverse Operations](https://antitoken.pro/assets/whitepaper/matrix-form.png)
Figure 2: Forward and Inverse Operations

Forward and inverse operations (1) and (2) can be written in matrix form as follows:

![Matrix Form](https://antitoken.pro/assets/whitepaper/matrix-form.png)
...
![Figure 6: The Antitoken Collective](https://antitoken.pro/assets/whitepaper/collective.png)
